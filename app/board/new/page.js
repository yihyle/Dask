      ...
      <div className="w-[850px] h-[655px] rounded-[20px] bg-white shadow-lg mt-11 p-8">
        ...
        <div className="w-full h-[70px] mt-8 flex flex-row items-center justify-center">
          <div className="w-full h-[70px] flex flex-col justify-center mb-4">
            <p className="text-[14px] text-black/70 mb-1">카테고리</p>
            <div className="relative inline-block w-[365px]">
              <select defaultValue="" className="appearance-none w-full h-[47px] border border-[#D7D7D7] rounded-[10px] pl-4 pr-10 bg-white focus:outline-none focus:border-[#05AA87] cursor-pointer">
          ...
          <div className="w-full h-[70px] flex flex-col justify-center mb-4">
            <p className="text-[14px] text-black/70 mb-1">익명 닉네임</p>
            <input className="w-full h-[47px] rounded-[10px] bg-white border border-[#D7D7D7] focus:outline-none focus:border-[#05AA87] pl-4 pr-4" />
          </div>
        </div>
        ...
        <div className="w-full h-[340px] center flex-col mt-8 gap-4">
          <div className="w-full h-[70px] flex flex-col justify-center mb-4">
            <p className="text-[14px] text-black/70 mb-1">제목</p>
            <input className="w-full h-[47px] rounded-[10px] bg-white border border-[#D7D7D7] focus:outline-none focus:border-[#05AA87] pl-4 pr-4" placeholder="제목을 입력하세요" />
          </div>
          <div className="w-full h-auto flex flex-col justify-center mb-4">
            <p className="text-[14px] text-black/70 mb-1">내용</p>
            <textarea className="w-full h-[215px] rounded-[10px] bg-white border border-[#D7D7D7] focus:outline-none focus:border-[#05AA87] pl-4 pr-4 py-2 resize-none" placeholder="내용을 입력하세요" />
          </div>
        </div>
